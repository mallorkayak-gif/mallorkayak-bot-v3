...
def fetch_all_data_for_zone(zona_name, lat, lon):
    """Obtiene datos de las 3 APIs para una zona (paralelo)"""
    results = {}
    
    # Peticiones paralelas
    with ThreadPoolExecutor(max_workers=3) as executor:
        futures = {
            executor.submit(get_openmeteo_data, lat, lon): "openmeteo",
            executor.submit(get_openweather_data, lat, lon): "openweather",
            executor.submit(get_weatherapi_data, lat, lon): "weatherapi",
        }
